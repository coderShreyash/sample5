...
class Board {
  constructor(canvas, ctx) {
    ...
    this.centerBorderFrontLeftPoint2d = utils.PROJECTOR.get2d(this.x - 7 / 400 * this.width, this.y, this.z);
    this.centerBorderFrontRightPoint2d = utils.PROJECTOR.get2d(this.x + 7 / 400 * this.width, this.y, this.z);
...
class Ball {
  constructor(ctx, board, x, y, z, soundsDiv) {
    ...
    this.bounceSound = new __WEBPACK_IMPORTED_MODULE_0__Sound_js__["a"]("sounds/bounce.mp3", this.soundsDiv);
...
class Bat {
  ...
  makeBatPaddle(hasServed) {
    ...
    this.ctx.fillStyle = "rgba(233,1,1,"+this.alpha+")";
    this.ctx.fill();
    this.ctx.closePath();
    this.ctx.beginPath();
    ...
    this.ctx.fillStyle = "rgba(240,185,145,"+this.alpha+")";
    this.ctx.fill();
...
class Game {
  constructor() {
    ...
    this.bgLinearGradient.addColorStop(0.5, "lightblue");
    this.bgLinearGradient.addColorStop(0.9, "lightgreen");
    ...
    this.bgGradient.addColorStop(0, 'lightgreen');
    this.bgGradient.addColorStop(1, 'lime');

    this.scoreBoardImagea = new Image();
    this.scoreBoardImagea.src = 'images/scoreboard.png';
    this.scoreBoardImagea.onload = ()=>{
      this.scoreBoard = {
        x1:this.canvas.width *0.12,
        y1:this.canvas.width *0.1,
        x2:this.canvas.width *0.8,
        image: this.scoreBoardImage,
      }
      this.ctx.drawImage(this.scoreBoardImagea,-this.scoreBoardImagea.width,0);
    }
  ...
  drawButton() {
    ...
    this.ctx.fillText("Table Tennis 3D", this.canvas.width/20, this.canvas.height / 6);
    this.ctx.strokeText("Table Tennis 3D", this.canvas.width/20, this.canvas.height /6);
    ...
    this.ctx.fillStyle = "black";
    this.ctx.font = "800 " + this.canvas.width * 0.025 + "px Arial";
    this.ctx.strokeStyle = "white"
    this.ctx.lineWidth = "1.5";
    this.ctx.fillText(this.button.text, this.button.x-20, this.button.y -10);
    this.ctx.strokeText(this.button.text, this.button.x-19, this.button.y-9);
  }
  handleClick(evt) {
  ...
  serve() {
    ...
    this.bounceSound = new __WEBPACK_IMPORTED_MODULE_3__Sound_js__["a"]("sounds/bounce.mp3", this.soundsDiv);
    this.bounceSound.play();
  }
  ...
  drawScore() {
    ...
    this.ctx.font = "900 30px Algerian";

    this.ctx.fillStyle = "#000";

    this.ctx.fillText("Your Score", this.scoreBoard.x1-50, this.scoreBoard.y1-45);

    this.ctx.fillStyle = "#dc143c";

    this.ctx.fillText("Opponent's Score", this.scoreBoard.x2-100, this.scoreBoard.y1-45);
